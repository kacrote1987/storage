...
//        //合并表格
//        xwpfHelperTable.mergeCellsHorizontal(infoTable, 0, 0,3);
//        xwpfHelperTable.mergeCellsHorizontal(infoTable, 1, 1, 3);
//        xwpfHelperTable.mergeCellsHorizontal(infoTable, 3, 1, 3);
//        xwpfHelperTable.mergeCellsHorizontal(infoTable, 8, 0, 3);
//        xwpfHelperTable.mergeCellsHorizontal(infoTable, 14, 1, 2);
////        xwpfHelperTable.mergeCellsHorizontal(infoTable, 18, 1, 3);
////        for(int col = 1; col < 4; col++) {
////            xwpfHelperTable.mergeCellsHorizontal(infoTable, col, 2, 3);
////        }
//        //设置表格样式
